      ...
      questions: [
        {
          ...
          question_text: 'What do you need help with?',
          question_type: 'multiple_choice',
          options: ['New install', 'Manifold issue', 'Cold zone/loop', 'Control/thermostat issue', 'Airlock/pressure issue'],
          required: true,
      ...
      questions: [
        {
          ...
          question_type: 'multiple_choice',
          options: ["Seized/doesn't turn", 'Leaking', 'Needs relocation/upgrade', 'Cannot locate main stop tap'],
          required: true,
          ...
          {service === 'Plumbing' && (
            <div>
              ...
              {selectedCategoryConfig && (
                <div className="mt-3">
                  <p className="text-sm text-gray-500 italic mb-4">{selectedCategoryConfig.category_description}</p>
