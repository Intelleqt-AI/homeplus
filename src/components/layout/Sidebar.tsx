...
const Sidebar = () => {
  ...
  const sidebarItems = [
    ...
    { icon: Quote, label: "Quotes", path: "/dashboard/quotes" },
    ...
    <>
      <nav className="fixed left-0 top-0 h-full w-[280px] bg-[#F8F8F3] border-r border-gray-200 z-40 flex-col p-4 flex">
        ...
        <div className="p-3 border border-[#EDEDED] rounded-[16px] flex items-center gap-3">
          ...
          <div className="">
            <h1 className="text-sm font-regular text-[#4B4B4B] aeonik">
              Home +
            </h1>
                ...
                <li key={item.path}>
                  <Link
                    ...
                    className={`flex items-center gap-3 px-[14px] py-3 rounded-lg text-sm font-medium transition-colors group ${
                      isActive
                        ? "bg-black text-white"
                        : "text-[#4A5565] hover:bg-black hover:text-white"
                    }`}>
                    <item.icon
        ...
        <div className="flex gap-3 items-center">
          ...
          <div className="flex flex-col">
            <p className="text-sm font-regular text-[#4B4B4B]">
              Michael Robinson
            </p>
