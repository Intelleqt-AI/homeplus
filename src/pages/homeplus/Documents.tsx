...
import { Upload, Download, Eye, Trash2, FileText, Package, Camera, CalendarIcon } from 'lucide-react';
...
import { deleteFile, listFilesWithMetadata, uploadFileWithMetadata } from '@/lib/Api';
      ...
      <DashboardLayout>
        <div className="space-y-6">
                    ...
                    docs
                      ...
                      ?.map(({ id, name, metadata, publicUrl }) => (
                        <tr key={id} className="border-b border-gray-100 hover:bg-gray-50/50">
                          ...
                          <td className="py-4 px-6 text-sm text-gray-600">{metadata?.metadata?.type}</td>
                          ...
                          <td className="py-4 px-6">
                            <div className="flex items-center space-x-2">
                              ...
                              {/* Delete file */}
                              <button onClick={() => handleDeleteTask(name)} className="p-1 hover:bg-gray-100 rounded transition-colors">
          ...
          >
            ...
            <h3 className="font-semibold text-black mb-2">Upload Your Documents</h3>
            <p className="text-sm text-gray-600">Click here to choose your documents</p>
            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="space-y-6 py-4">
                <div className="text-center space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Upload receipts, warranties, certificates, or any home-related documents to automatically organize them.
                    </p>
                  </div>
                </div>
                      ...
                      <label htmlFor="file-upload">
                        <div className="flex items-center justify-center p-6 border-2 border-dashed border-border rounded-lg hover:bg-secondary cursor-pointer transition-colors">
                          <div className="text-center">
                            ...
                            <p className="text-sm font-medium text-foreground">{selectedFile ? selectedFile.name : 'Click to upload'}</p>
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        ...
                        >
                          ...
                          {selectedDate ? <>Valid until {format(selectedDate, 'PPP')}</> : <span>Select validity date</span>}
                        </Button>
                      </PopoverTrigger>
                ...
                <div className="flex space-x-3 pt-2">
                  ...
                  <Button variant="outline" className="flex-1" onClick={() => setOpenForm(false)}>
                    Cancel
                  </Button>
                </div>
              </div>
